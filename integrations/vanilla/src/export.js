/* eslint-disable */
/* THIS FILE WAS AUTO-GENERATED USING CATALOG EXPORTER; YOU SHOULD NOT EDIT THIS FILE; GENERATE TIME: 2024-02-22T20:32:07.335Z; */
 ...
 * Metric Type: MAQL Metric
 */
export const Delivered = newMeasure(idRef("delivered", "measure"));
/**
 ...
 * Metric Type: MAQL Metric
 */
export const TotalDiscountsN = newMeasure(idRef("negative_total_discounts", "measure"));
/**
 * Metric Title: Total Returns N
 * Metric ID: negative_total_return
 * Metric Type: MAQL Metric
 */
export const TotalReturnsN = newMeasure(idRef("negative_total_return", "measure"));
/**
 ...
 * Metric Type: MAQL Metric
 */
export const NrOfSingleOrders = newMeasure(idRef("of_orders_1", "measure"));
/**
 * Metric Title: # of Orders by Customer
 * Metric ID: of_orders_by_customer
 * Metric Type: MAQL Metric
 */
export const NrOfOrdersByCustomer = newMeasure(idRef("of_orders_by_customer", "measure"));
/**
...
export const Insights = {
  ...
  /**
   * Insight Title: Gross Profit forecast_prediction_plugin_
   * Insight ID: 098740ee-ad7c-4b27-8ff0-4ae8531a8100
   */,
  GrossProfitForecastPredictionPlugin: "098740ee-ad7c-4b27-8ff0-4ae8531a8100"
  /**
